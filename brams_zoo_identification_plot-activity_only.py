# -*- coding: utf-8 -*-
"""
Create meteor activity graph with the radiant elevation
...
DATE = "20161017"
STATION = "BEHUMA"
title = "Radio Meteor Zoo\n (Perseids 2016, Humain receiving station)"
...
OUTPUT_PLOT = "Perseids2016-%s-%s-mod.png" % (DATE, STATION)
